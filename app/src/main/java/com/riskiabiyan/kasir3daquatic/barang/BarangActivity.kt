package com.riskiabiyan.kasir3daquatic.barang
...
import com.riskiabiyan.kasir3daquatic.tambahBarang.TambahBarangTampilKategori

class BarangActivity : AppCompatActivity(), GetBarang {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnKeTBarang.setOnClickListener {
            startActivity(Intent(this, TambahBarangTampilKategori::class.java))
        }
    ...
    override fun onSuccessGetBarang(barangResponse: BarangResponse){
        ...
        var rv = binding.RecBarang
        rv.adapter = barangAdapter
        rv.layoutManager = LinearLayoutManager(this)
        barangAdapter.setDataList(barangResponseItem)
    }
